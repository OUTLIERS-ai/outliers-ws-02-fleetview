...
const DEFAULT_WAIT_CAP_H = 8;          // a wait older than this is treated as idle (finished and left)
...
function createStore(opts = {}) {
  ...
  //    (or for up to waiting_hours, 8 by default, after which it counts as finished and left)
